...
st.set_page_config(page_title="DSBS - Handledning & Undervisning", page_icon="favicon.ico",)

st.image("logo.png", width=180)
st.title ("Handledning och Undervisning på Drottning Silvias Barn och Ungdomssjukhus")
